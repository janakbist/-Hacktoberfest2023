...
class HomepageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    SimpleFontelicoProgressDialog _loading = SimpleFontelicoProgressDialog(context: context);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        Flexible(child: Text("${Get.arguments}")),
  ...
  void openFacebookApp() async {
  const  facebookUrl = 'fb://page/{jackson.bist.1}'; 

  if (await canLaunch(facebookUrl)) {
    // Open the Facebook app
    await launch(facebookUrl);
  } else {
    // Facebook app is not installed, open it in a browser
    const webUrl = 'https://www.facebook.com/{jackson.bist.1}'; 
    await launch(webUrl);
  }
}
